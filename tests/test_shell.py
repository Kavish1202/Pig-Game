...
#     assert "Total score: 0 points." in out2  
#     assert "Player 2's turn."    # next player's turn line
...
#     sh._cpu_take_turn()
#     out = capsys.readouterr().out
#     assert "Player 2 rolled 4" in out
#     assert "CPU holds." in out
#     assert "CPU score: 4 points." in out
#     assert "Player 1's turn." in out
...
#     sh._cpu_take_turn()
#     out = capsys.readouterr().out
#     assert "Player 2 rolled 1" in out
...
# tests for the cmd-based shell (pig/shell.py)
# keep comments human and short.
